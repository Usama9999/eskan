...
class ApprovedPropertyDetailsScreen extends StatefulWidget {
  ...
  @override
  _ApprovedPropertyDetailsScreenState createState() =>
      _ApprovedPropertyDetailsScreenState();
}

class _ApprovedPropertyDetailsScreenState
    extends State<ApprovedPropertyDetailsScreen> {
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Container(
          ...
          child: Column(
            ...
            children: [
              ButtonWidget(
                buttonText: 'UnApprove Ad',
                onPressed: () async {
                  changedAd = true;
                  DataRepository dataRepository = DataRepository();

                  await dataRepository.unapproved(context, propertyModel,
                      propertyModel.apartmentType, commentController.text);
                  Get.back();
                  mainController.approvedProperties.removeWhere(
                    (element) => element.docId == propertyModel.docId,
                  );
                  mainController.update();

                  setState(() {
                    propertyModel.approved = false;
                  });
                },
              ),
            ],
