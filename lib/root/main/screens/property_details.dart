...
class _PropertyDetailsScreenState extends State<PropertyDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    log(widget.propertyModel.userId);
    log(Get.find<UserDetail>().userId);
    ...
    return WillPopScope(
      ...
      child: GetBuilder<UserDetail>(builder: (value) {
        return Scaffold(
          ...
          bottomNavigationBar: (value.admin && value.login) ||
                  widget.propertyModel.userId == Get.find<UserDetail>().userId
              ? Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ButtonWidget(
                        buttonText: propertyModel.adEnabled
                            ? 'Disable Ad'
                            : 'Enable Ad',
                        onPressed: () async {
                          if (propertyModel.adEnabled) {
                            DataRepository dataRepository = DataRepository();

                            await dataRepository.disableAd(
                                context,
                                propertyModel,
                                propertyModel.apartmentType,
                                commentController.text);
                            setState(() {
                              propertyModel.adEnabled = false;
                            });
                          } else {
                            DataRepository dataRepository = DataRepository();

                            await dataRepository.enableAd(
                                context,
                                propertyModel,
                                propertyModel.apartmentType,
                                commentController.text);
                      ...
                      children: [
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            CachedNetworkImage(
                                                                          imageUrl:
                                                                              propertyModel.propertyImages[pagePosition % propertyModel.propertyImages.length],
                                                                          height:
                                                                              550,
                                                                          fit: BoxFit
                                                                              .fill,
                        ...
                        if (propertyModel.userId ==
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                mainController.editPoperty(propertyModel);
                              },
                              child: ClipRRect(
                                borderRadius:
                                    BorderRadius.all(Radius.circular(40)),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding:
                                UiUtils.getDeviceBasedPadding(10, 10, 10, 0),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                    ...
                    if (!widget.myOwnProperty)
                      Column(
                        children: [
                          ...
                          Padding(
                            padding:
                                UiUtils.getDeviceBasedPadding(15, 0, 15, 30),
                            child: Column(
                              children: [
                                Row(
                                  children: [
                                    ...
                                    TextWidget(
                                      text:
                                          widget.propertyModel.postedBy.isEmpty
                                              ? 'Administrator'
                                ...
                                Row(
                                  children: [
                                    ...
                                    TextWidget(
                                      text:
                                          widget.propertyModel.location.isEmpty
  ...
  Future<String> createDynamicLink(String propertyType, String addId) async {
    var parameters = DynamicLinkParameters(
      uriPrefix: 'https://eskan.page.link',
      link: Uri.parse(
          'https://eskan.page.link.com/?propertyType=$propertyType&addId=$addId'),
      androidParameters: AndroidParameters(
        packageName: "com.example.eskan",
      ),
      iosParameters: IOSParameters(
          bundleId: "com.example.eskan",
          customScheme: "https://eskan.page.link",
          appStoreId: '232323'),
    );
