...
import 'package:eskan/root/main/screens/pending_property_details.dart';
...
class PendingExploreScreen extends StatefulWidget {
  @override
  _PendingExploreScreenState createState() => _PendingExploreScreenState();
}

class _PendingExploreScreenState extends State<PendingExploreScreen>
  ...
  Future<void> getPendingProperties(
      {bool goToSharedAdd = false, bool showLoading = true}) async {
    final DataRepository repository = DataRepository();
    await repository.getAllPendingProperties(
      context,
      mainController,
                      ...
                      child: GetBuilder<MainController>(
                        builder: (logic) {
                          return ListView.builder(
                              itemCount:
                                  mainController.pendingProperties.length,
                                        ...
                                        children: [
                                          ...
                                          TextWidget(
                                            text: mainController
                                                    .pendingProperties
                                                    .isNotEmpty
                                                ? "${mainController.pendingProperties[index].price} QAR"
                                                : '',
